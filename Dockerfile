...
ENV ORIGINS="https://opendev-labs-nanopi.hf.space"
...
ENV OPENID_PROVIDER_URL="https://accounts.google.com/.well-known/openid-configuration"
...
ENV WEBUI_TITLE="NanoPi (opendev-labs)"
